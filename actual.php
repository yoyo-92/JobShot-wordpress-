...
function view_applylist_func_test ( $atts ) {
  ...
  <style type="text/css">
    ...
    td.event_management_name {
      font-weight: bold;
      font-size: 15px !important;
    }
    td.fevent_management_furigana{
          ...
          <div class = "event_management_info">
            <table class="tbl02">
              <tbody>
                ...
                <tr>
                  <th>興味ある業界</th>
                  <td  colspan="2" class="over event_management_kyomi_gyo"><div class="event_management_modi event_management_center" ><p>[get_user_bussiness_type field=login value="${your-id}"]</div></p></td>
                </tr>
              </tbody>
            </table>
          </div>
