            ...
            <div class = "info">
              <table class="tbl02">
                <tbody>
                    <tr>
                        <th>フリガナ</th>
                        <td class="modi center furigana"><p>[get_user_ruby field=login value="${your-id}"]</p></td>
                    ...
                    <tr>
                        <th>卒業年度</th>
                        <td class="modi center" colspan="2"><p>[get_user_graduate_year field=login value="${your-id}"]</p><p>[get_user_school_year ield=login value="${your-id}"]</p></td>
                    </tr>
                    <tr>
                        <th>資格</th>
                    ...
                    <tr>
                        <th>興味ある業界</th>
                        <td  colspan="2" class="over event_management_kyomi_gyo"><div class="modi center" ><p>[get_user_bussiness_type field=login value="${your-id}"]</div></p></td>
                    </tr>
                </tbody>
              </table>
            </div>
