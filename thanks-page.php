...
function add_thankspage(){
    ...
    <div class="thankyou-main">
        <div class="reccomend-internship">
            ...
            <a href="https://builds-story.com/internship" class="btn-flat-border">他のインターンを探す</a>
        </div>
        <hr>
        <div class="after-flow-internship">
            <h2>長期インターンの合格率は20％以下！？</h2>
            <figure><img src="https://builds-story.com/wp-content/uploads/2019/09/f40e747caf1794220abe699050de4df7_s_upscaled_image_x4.jpg" alt=""></figure>
            <div>
            ...
            <div class="thankyou-next">
                <p><a href="https://builds-story.com/user" class="btn-flat-border-white">プロフィールを充実させる</a></p>
                <p><a href="https://builds-story.com/internship" class="btn-flat-border-white">他のインターンを探す</a></p>
                <p><a href="https://builds-story.com/interview" class="btn-flat-border-white">面接対策を行う</a></p>
            </div>
        </div>
        </div>
    ';
